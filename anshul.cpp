...
void save_contact()
{
	fp.open("contactBook.db",ios::out|ios::app);
	cont.create_contact();
...
void edit_contact()
{
	...
	fp.open("contactBook.db",ios::in|ios::out);
...
void delete_contact()
{
	...
	fp2.close();
	fp.close();
	remove("contactBook.db");
	rename("Temp.db","contactBook.db");
